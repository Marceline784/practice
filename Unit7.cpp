...
void __fastcall TForm7::AdvGlowButton5Click(TObject *Sender)
{
int napijID = 6;
	Form6->AddToCart(napijID);
	ShowMessage("Напій додано до кошика!");
...
void __fastcall TForm7::AdvGlowButton1Click(TObject *Sender)
{
int napijID = 2;
	Form6->AddToCart(napijID);
	ShowMessage("Напій додано до кошика!");
...
void __fastcall TForm7::AdvGlowButton3Click(TObject *Sender)
{
int napijID = 4;
	Form6->AddToCart(napijID);
	ShowMessage("Напій додано до кошика!");
...
void __fastcall TForm7::AdvGlowButton4Click(TObject *Sender)
{
int napijID = 5;
	Form6->AddToCart(napijID);
	ShowMessage("Напій додано до кошика!");
